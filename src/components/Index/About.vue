            ...
            <div class="wrapper">
                <div class="main">
                    <div class="content">
                        ...
                        <p class="para top1">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting,</p>
                        ...
                        <p class="para top">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, </p>
                    </div>
                    <div class="content">
                        <h2 class="style list"><a href="#">Meat our team!</a></h2>
                        <div class="span3">
                            <div class="span1_of_3">
                                <a href=""><img src="/static/images/pic4.jpg" alt=""/></a>
                            ...
                            <div class="span1_of_3">
                                <a href=""><img src="/static/images/pic5.jpg" alt=""/></a>
                            ...
                            <div class="span1_of_3">
                                <a href=""><img src="/static/images/pic6.jpg" alt=""/></a>
                        ...
                        <div class="span2">
                            <div class="span1_of_2">
                                <a href=""><img src="/static/images/pic7.jpg" alt=""/></a>
                                <h4 class="style top1"><a href="">Blaze Robar</a></h4>
                                <h5 class="style">Design Guru</h5>
                                <p class="para">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC,</p>
                            </div>
                            <div class="span1_of_2">
                                <a href=""><img src="/static/images/pic8.jpg" alt=""/></a>
